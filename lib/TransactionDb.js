...
var CONCURRENCY = 10;
// A.I. Coin has 0 confirmations as its blockchain does not fork.
var DEFAULT_SAFE_CONFIRMATIONS = 0;
...
var TransactionDb = function() {
  ...
  logger.info('bitcore %s ', bitcore);
  logger.info('networks %s ', bitcore.networks);
